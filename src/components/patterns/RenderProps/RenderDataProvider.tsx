...
// Render Props — это паттерн в React, при котором компонент принимает функцию как пропс (обычно называемую render или children), и эта функция возвращает React-элементы.
